...
<div id="container">
        ...
        <div class="wrapper">
                    ...
                    <ul id="menu-unnamed-2" class="menu">
                        ...
                        <li id="menu-item-9816" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9816"><a href="https://auca.ac.rw/academics/">Academics</a>
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-9877" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9877"><a href="https://auca.ac.rw/academic-bulletin-2/">Academic Bulletin</a>
                                    <ul class="sub-menu">
                                        <li id="menu-item-9952" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9952"><a href="https://auca.ac.rw/bba-bulletin/">Bulletin 2022-2025</a></li>
                                    </ul>
                                </li>
            ...
            <div id="navbar-main">
                ...
                <div class="menu-unnamed-2-container">
                    <ul id="menu-unnamed-3" class="navbar-wpz dropdown sf-menu"> <li id="menu-item-9801" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-6070 current_page_item menu-item-9801"><a href="https://auca.ac.rw/" aria-current="page">Home</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9816"><a href="https://auca.ac.rw/academics/">Academics</a>
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9877"><a href="https://auca.ac.rw/academic-bulletin-2/">Academic Bulletin</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9952"><a href="https://auca.ac.rw/bba-bulletin/">Bulletin 2022-2025</a></li>
                                    </ul>
                                </li>
        ...
        <div class="wrapper">
            ...
            <div class="column column-narrow">
                ...
                <div class="widget pi_tweet_scroll widget-grey" id="pi_tweet_scroll-2">
                    ...
                    <div id="tweets-list-id-987" class="tweets-list-container aside" data-instance-id="2" data-post-id="7282"></div>

                    <script>
                        jQuery(function($) {
                            /* ================ TWEETS SCROLL ================ */
                            jQuery('#tweets-list-id-987').tweetscroll({
                        ...
                        <div id="calendar_wrap" class="calendar_wrap">
                            <table id="wp-calendar" class="wp-calendar-table">
                                ...
                                <tr>
                                    ...
                                    <td>11</td>
                                    <td>12</td>
                                    <td><a href="https://auca.ac.rw/2024/03/13/" aria-label="Posts published on March 13, 2024">13</a></td>
                                    <td>14</td>
                                    <td id="today">15</td>
                                    <td>16</td>
                                </tr>
    ...
    <footer class="site-footer">
        ...
        <form action = "LogoutServlet" method="post" >
            <!-- Add any additional fields or styling here if needed -->
